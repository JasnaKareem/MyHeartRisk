...
st.write('This app uses machine learning to predict the likelihood of heart disease based on user-provided health parameters. Adjust the options in the sidebar located at the top left corner ( >> ) to input your health data and click "Check" to see your risk assessment.')
# Load dataset
