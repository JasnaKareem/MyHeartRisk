...
st.write('This app uses machine learning to predict the likelihood of Coronary Heart Disease based on user-provided health parameters. Adjust the options in the sidebar (if the side bar is closed, Click on >> arrow symbol to open the sidebar) to input your health data and click "Check" to see your risk assessment.')
# Load dataset
...
st.sidebar.write("Give Your Parameters and Click 'Check' to Predict Coronary Heart Disease Risk.")
...
with tab1:
    if predict_btn:
        ...
        if prediction == 1:
            st.write("**⚠️ Your Parameters Resemble That of Patient Cases With Coronary Heart Disease. Take Care of Yourself. Coronary Heart Disease Predicted**")
            confidence = probabilities[1] * 100
        else:
            st.write("**✅ Your Parameters Don’t Resemble Patient Cases With Coronary Heart Disease. No Coronary Heart Disease Predicted**")
...
with tab2:
    ...
    st.image(pca, caption='PCA Plot Showing Distribution of Cases and Controls (Cummalative Variance: 37%)')
...
with tab3:
    ...
    - **Accuracy**: 0.94 ± 0.01
    - **Sensitivity**: 0.92 ± 0.04
    - **Specificity**: 0.95 ± 0.03
    - **MCC**: 0.88 ± 0.02
    
    External Validation Metrics for 20 Samples (10 Cases and 10 Controls):
    - **Accuracy**: 1.00
    - **Sensitivity**: 1.00
    - **Specificity**: 1.00
    - **MCC**: 1.00
    ...
    These metrics indicate that the model is quite effective at predicting Coronary Heart Disease based on the provided health parameters.
    """)

with tab4:
    st.subheader('Interpretation: Logistic Regression Coefficients')
    st.write('This section provides insights into how different health parameters influence the prediction of Coronary Heart Disease. Understanding these factors can help in making informed health decisions.')
